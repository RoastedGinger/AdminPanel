...
public class Tech extends AppCompatActivity {
    ...
    private static final String URL_PRODUCTS = "https://beholden-effects.000webhostapp.com/DomPowCom/techfetch.php";

    //a list to store all the products
    List<AssignTechs> techsList;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            TechAdapter adapter = new TechAdapter( getApplicationContext(),techsList);
